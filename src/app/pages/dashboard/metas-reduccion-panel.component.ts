 ...
 * progreso, calculado en el backend contra el período/año seleccionado en
 * el dashboard (mismo selector que "Resumen de huella").
 *
 * Presentacional: el fetch y el manejo de error viven en `dashboard-page`,
 * mismo patrón que los demás bloques del dashboard de Certificaciones —
 * una falla acá no afecta al resto de la página.
 */
@Component({
